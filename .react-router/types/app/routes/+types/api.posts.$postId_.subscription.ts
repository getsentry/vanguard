...
type Module = typeof import("../api.posts.$postId_.subscription.js");

type Info = GetInfo<{
  file: "routes/api.posts.$postId_.subscription.ts";
  module: Module;
}>;
...
type Matches = [
  ...
  },
  {
    ...
    module: typeof import("../api.posts.$postId_.subscription.js");
  },
];
